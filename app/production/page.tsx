...
const reportTypes = [
  ...
  {
    id: 'batch-planner',
    name: 'Batch Planner (Classic)',
    description: 'Group similar tasks across orders - card-based view',
  ...
  {
    id: 'batch-builder',
    name: 'Batch Builder (New)',
    description: 'Build batches like mixing a recipe - drag items into bucket',
  ...
  },
  {
    ...
    description: 'View and print order assignments with images',
  ...
  },
  {
    id: 'cakeboards',
    name: 'Cakeboards',
    description: 'Manage cakeboard types and assignments',
